    ...
    <article class="project-detail" style="max-width: 960px; margin: 0 auto; padding: 2rem 1rem;">
      ...
      <div class="project-body stagger-el stagger-delay-3">
        ...
        <section class="body-chapter" style="border-bottom: 1px solid var(--border-color); padding-bottom: 5.5rem; margin-bottom: 5.5rem;">
          ...
          <h2 class="chapter-title font-serif" style="font-size: clamp(1.8rem, 4vw, 2.4rem); margin-top: 0.5rem; line-height: 1.15; font-weight: 400; margin-bottom: 2rem;">When a 90% Success Rate Hides a Retention Crisis</h2>
...
const sidebarActionGrid = `
      ...
      <div class="sidebar-cta-card">
        ...
        <div class="cta-buttons-grid">
          ...
          <a href="https://drive.google.com/file/d/1ljVaMgg9SkdwbJgsT06UI4DbldX15hjA/view?usp=drive_link" class="cta-action-btn" target="_blank" rel="noopener" aria-label="View Resume">
