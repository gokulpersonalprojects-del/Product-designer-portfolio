    ...
    <article class="project-detail">
      ...
      <div class="project-body stagger-el stagger-delay-3">
        ...
        <section class="body-chapter" style="border-bottom: 1px solid var(--border-color); padding-bottom: 2.5rem; margin-bottom: 0;">
          ...
          <p class="chapter-desc" style="margin-bottom: 1.5rem;">
            Before moving into solutions, we explored multiple ways to address the engagement and retention challenges identified during research. The goal was not simply to improve the chatbot experience, but to understand how Yooki could become a more meaningful part of an aspirant's preparation journey.
          </p>
          
          <div class="directions-grid" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1.25rem;">
            <div style="padding: 1.25rem; background: var(--bg-card); border: 1px solid var(--border-color); border-radius: var(--border-radius-lg); display: flex; flex-direction: column; justify-content: space-between; gap: 1.5rem;">
              <div>
                <span class="font-mono" style="font-size: 0.65rem; color: var(--text-muted); letter-spacing: 0.05em; text-transform: uppercase;">DIRECTION 01</span>
                <h4 class="font-serif" style="font-size: 1.15rem; font-weight: 500; margin: 0.4rem 0 0; color: var(--text-primary); line-height: 1.2;">Structured Flow</h4>
                <p style="font-size: 0.85rem; line-height: 1.5; color: var(--text-secondary); margin-top: 0.5rem; margin-bottom: 0;">
                  This would force users into a structured preparation flow.
                </p>
              </div>
              <div style="padding: 0.75rem; background: rgba(255,59,48,0.06); border: 1px solid rgba(255,59,48,0.15); border-radius: var(--border-radius-md); font-size: 0.8rem; color: #ff3b30; font-family: var(--font-mono); font-weight: 500;">
                RISK: Removes the platform's most valuable feature.
              </div>
            </div>
            
            <div style="padding: 1.25rem; background: var(--bg-card); border: 1px solid var(--border-color); border-radius: var(--border-radius-lg); display: flex; flex-direction: column; justify-content: space-between; gap: 1.5rem;">
              <div>
                <span class="font-mono" style="font-size: 0.65rem; color: var(--text-muted); letter-spacing: 0.05em; text-transform: uppercase;">DIRECTION 02</span>
                <h4 class="font-serif" style="font-size: 1.15rem; font-weight: 500; margin: 0.4rem 0 0; color: var(--text-primary); line-height: 1.2;">Recommendations</h4>
                <p style="font-size: 0.85rem; line-height: 1.5; color: var(--text-secondary); margin-top: 0.5rem; margin-bottom: 0;">
                  Add recommendations and discovery mechanisms.
                </p>
              </div>
              <div style="padding: 0.75rem; background: rgba(255,109,0,0.06); border: 1px solid rgba(255,109,0,0.15); border-radius: var(--border-radius-md); font-size: 0.8rem; color: var(--color-accent); font-family: var(--font-mono); font-weight: 500;">
                RISK: Users still remain in a question answer workflow.
              </div>
            </div>
            
            <div style="padding: 1.25rem; background: rgba(138,43,226,0.04); border: 1px solid var(--color-brand); border-radius: var(--border-radius-lg); display: flex; flex-direction: column; justify-content: space-between; gap: 1.5rem; box-shadow: 0 8px 20px rgba(138,43,226,0.03);">
              <div>
                <span class="font-mono" style="font-size: 0.65rem; color: var(--color-brand); letter-spacing: 0.05em; text-transform: uppercase; font-weight: bold;">SELECTED DIRECTION</span>
                <h4 class="font-serif" style="font-size: 1.15rem; font-weight: 500; margin: 0.4rem 0 0; color: var(--text-primary); line-height: 1.2;">Chatbot as Entry Point</h4>
                <p style="font-size: 0.85rem; line-height: 1.5; color: var(--text-secondary); margin-top: 0.5rem; margin-bottom: 0;">
                  Keep the chatbot while using it as an entry point into the learning journey.
                </p>
              </div>
              <div style="padding: 0.75rem; background: rgba(52,199,89,0.06); border: 1px solid rgba(52,199,89,0.18); border-radius: var(--border-radius-md); font-size: 0.8rem; color: #34c759; font-family: var(--font-mono); font-weight: 600; text-align: center;">
                REASON: Balances user needs with business goals.
              </div>
            </div>
          </div>
        </section>
