            ...
            <div class="bop-carousel-track-wrapper">
              <div class="bop-carousel-track" id="bop-rejected-carousel-track">
                ...
                <div class="bop-carousel-slide">
                  ...
                  <div class="bop-carousel-caption">
                    <span class="caption-tag font-mono">01 / REQUIREMENTS CHECKLIST</span>
                    <p class="caption-desc">Prerequisite checklist forcing users to read terms upfront.</p>
                  </div>
                </div>
                <!-- Slide 2 -->
                <div class="bop-carousel-slide">
                  ...
                  <div class="bop-carousel-caption">
                    <span class="caption-tag font-mono">02 / PHONE &amp; EMAIL CAPTURE</span>
                    <p class="caption-desc">Unified entry form containing multiple high-friction fields.</p>
                  </div>
                </div>
                <!-- Slide 3 -->
                <div class="bop-carousel-slide">
                  ...
                  <div class="bop-carousel-caption">
                    <span class="caption-tag font-mono">03 / TELECOM OTP VERIFICATION</span>
                    <p class="caption-desc">Standard timed SMS verification code entry interface.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem; margin-bottom: 2.0rem;">
              <div style="padding: 1.25rem; background: rgba(235, 87, 87, 0.03); border: 1px solid rgba(235, 87, 87, 0.2); border-radius: var(--border-radius-md); display: flex; flex-direction: column; justify-content: space-between;">
                <div>
                  ...
                  <p style="margin: 0 0 1rem 0; font-size: 0.85rem; line-height: 1.5; color: var(--text-secondary);">
