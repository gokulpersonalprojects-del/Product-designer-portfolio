    ...
    <article class="project-detail">
      ...
      <div class="project-body stagger-el stagger-delay-3">
        ...
        <section class="body-chapter" style="border-bottom: 1px solid var(--border-color); padding-bottom: 2.5rem; margin-bottom: 0;">
          ...
          <div class="problem-image-wrapper" style="margin-top: 2rem; border-radius: var(--border-radius-lg); overflow: hidden; border: 1px solid var(--border-color); box-shadow: var(--shadow-sm); background: var(--bg-card);">
            <img src="https://drive.google.com/uc?export=view&id=1RXq_HAVGTx9eTJFmGaUOBBUWpqnGcjb8" alt="Branch-Assisted vs Digital Onboarding Friction" style="width: 100%; height: auto; display: block;" loading="lazy">
          </div>
        </section>
            ...
            <div class="bop-carousel-track-wrapper">
              <div class="bop-carousel-track" id="bop-rejected-carousel-track">
                ...
                <div class="bop-carousel-slide">
                  <img src="https://drive.google.com/uc?export=view&id=1L_OHkvRM44SLbKaEAy8Jx4OfmWeYMdUk" alt="Requirements screen draft" loading="lazy">
                </div>
                <!-- Slide 2 -->
                <div class="bop-carousel-slide">
                  <img src="https://drive.google.com/uc?export=view&id=1UOEb7mRH-BMtqddIbvApv_rw01dVLpdB" alt="Form entries draft" loading="lazy">
                </div>
                <!-- Slide 3 -->
                <div class="bop-carousel-slide">
                  <img src="https://drive.google.com/uc?export=view&id=1szDSPDWTBNHJ0SbG_bnhiwjce_3wawKV" alt="Verification check draft" loading="lazy">
                </div>
              </div>
            </div>
        ...
        <section class="body-chapter" style="border-bottom: 1px solid var(--border-color); padding-bottom: 2.5rem; margin-bottom: 0;">
          ...
          <div style="margin-top: 2.5rem; border-top: 1px solid var(--border-color); padding-top: 2rem;">
            ...
            <div style="border-radius: var(--border-radius-lg); overflow: hidden; border: 1px solid var(--border-color); background: var(--bg-card); max-width: 700px; margin: 2.5rem auto;">
              <img src="./bop_simulator_replacement.png" alt="Interactive Mobile Onboarding Simulator Mockup" style="width: 100%; height: auto; display: block;" loading="lazy">
            </div>
          </div>
          ...
          <div style="margin-top: 2.5rem; border-top: 1px solid var(--border-color); padding-top: 2rem;">
            ...
            <div class="bop-comparison-grid" style="margin-bottom: 1.5rem;">
              <div style="background: rgba(235, 87, 87, 0.03); border: 1px solid rgba(235, 87, 87, 0.2); border-radius: var(--border-radius-md); display: flex; flex-direction: column; overflow: hidden;">
                ...
                <div style="border-top: 1px solid rgba(235, 87, 87, 0.1); width: 100%; margin-top: auto;">
                  <img src="https://drive.google.com/uc?export=view&id=1Us3t27TUtELMYsE1G2LbCZcS-QGOX1Nl" alt="Before: Hidden status tracking" style="width: 100% !important; height: auto; display: block;" loading="lazy">
                </div>
              </div>
              <div style="background: rgba(52, 199, 89, 0.03); border: 1px solid rgba(52, 199, 89, 0.2); border-radius: var(--border-radius-md); display: flex; flex-direction: column; overflow: hidden;">
                <div style="padding: 1.25rem 1.25rem 0.5rem 1.25rem;">
