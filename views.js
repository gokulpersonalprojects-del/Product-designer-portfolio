...
export function renderBrandStack() {
  return `
    <article class="brand-stack-page">
      ...
      <section class="brand-stack-section stagger-el stagger-delay-6" style="margin-top: 4rem;">
      ...
      <div class="brand-footer-grid stagger-el stagger-delay-7" style="margin-top: 4rem; margin-bottom: 4rem;">
